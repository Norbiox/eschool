...
urlpatterns = [
    ...
    path('lesson/', include([
        ...
        # ex: /school/lesson/1/
        path('<int:lesson_pk>/', views.LessonView.as_view(), name='lesson_details'),
    ])),

    # ex: /school/taught/1/
    path('taught/<int:taught_pk>/', views.TaughtView.as_view(), \
        name='taught_details'),

    # ex: /school/my-classes
    path('groups/', views.GroupsList.as_view(), name='groups'),
    # ex: /school/group/1/
    path('group/<str:abbrev>/', include([
        path('', views.GroupView.as_view(), name='group_details'),
        # ex: /school/group/1/give_grades/
        path('give_grades/', views.GiveGroupGradesView.as_view(), name='give_group_grades'),
    ])),
    ...
    # ex: /school/teacher/1/
    path('teacher/<int:teacher_pk>/', views.TeacherView.as_view(), \
